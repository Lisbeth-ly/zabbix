...
instantaneous_input_kbps)
        result=`$REDIS_INFO|/bin/grep instantaneous_input_kbps|awk -F":" '{print $NF}'`
        echo $result
;;
instantaneous_output_kbps)
        result=`$REDIS_INFO|/bin/grep instantaneous_output_kbps|awk -F":" '{print $NF}'`
        echo $result
;;
